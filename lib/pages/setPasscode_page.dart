...
class _SetPasscodePageState extends State<SetPasscodePage> {
  ...
  pinIndexSetup(String text) {
    ...
    if (pinIndex == 4) {
      navigateAndCheckPasscode(context, strPin);
    }
  }

  Future<void> navigateAndCheckPasscode(
      BuildContext context, String passcode) async {
    ...
    if (result) {
      boxSettings.putAll({"passcodeEnabled": "true", "passcode": passcode});
